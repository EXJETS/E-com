    ...
    <div className="charter-root">
      <header className="sticky top-0 z-40 border-b border-[var(--jet-line-soft)] bg-[rgba(8,13,22,0.82)] backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8">
          <Link href="/charter" className="flex items-baseline gap-2">
          ...
          <a
            href="#search"
            className="jet-cta px-4 py-2 text-[13px] sm:px-5"
          >
            Request a quote
          </a>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-[13px] text-[var(--jet-muted)]">
              ...
              <Link href="/" className="hover:text-[var(--jet-text)]">
                GlowCart store
              </Link>
            </div>
          </div>
